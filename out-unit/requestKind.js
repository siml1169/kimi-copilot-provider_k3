...
exports.classifyRequestKind = classifyRequestKind;
exports.isReportableContextRequest = isReportableContextRequest;
 ...
 */
function classifyRequestKind(firstText, latestUserText, toolNames) {
 ...
 */
function isReportableContextRequest(kind) {
    return kind === 'main-agent' || kind === 'background';
}
//# sourceMappingURL=requestKind.js.map